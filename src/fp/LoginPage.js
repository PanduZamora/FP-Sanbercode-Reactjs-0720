          ...
          <form>
            <Typography component="h2" variant="subtitle1">
              <ol>
                ...
                <Button class="button" variant="outlined" color="primary" onClick={handleLogin}>Masuk</Button>
                <Button class="button" variant="outlined" color="secondary" onClick={handleRegister}>Daftar</Button>
                <p>{tanda}</p>
              </ol>
            </Typography>
          </form>
